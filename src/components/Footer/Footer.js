...
const Footer = () => {
    return (
        <div>
            <footer class="text-gray-600 align-middle text-center body-font">
                <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col text-center">
                    <a class="flex title-font font-medium items-center md:justify-center justify-center text-gray-900 text-center">
      ...
      <a href="https://twitter.com/knyttneve" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">MAHFUZ-ANTOR</a>
                    </p>
